...
def init_db():
    ...
    # Eski veritabanlarında eksik sütunları kontrol et
    ...
    # Eski kayıtlarda seen_at boşsa mevcut zamanı yaz
    cur.execute("""
        UPDATE prices
        SET seen_at = ?
...
def build_routes():
    ...
    domestic_destinations = settings[
        "airports"
    ]["domestic_destinations"]

    europe_destinations = settings[
        "airports"
    ]["europe_destinations"]
