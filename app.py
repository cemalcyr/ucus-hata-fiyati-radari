...
def create_database():
    ...
    # Eski veritabanı varsa flight_key eksik olabilir.
    columns = [
        row[1]
...
def verify_flight(
    ...
    for candidate in flights:
        ...
        # Aynı uçuş/fiyat var fakat kaynak
        # henüz verified demiyor.
...
def main():
    ...
    # Sistem oturduktan sonra bütün rotalara açacağız.
    ...
    for number, (
        ...
        for flight in flights:
            ...
            # Şimdilik TRY dışındaki fiyatları
            # Error Score geçmişine katmıyoruz.
            ...
            verification = {
                ...
                "reason": (
                    ...
                    "olduğu için henüz doğrulama yapılmadı."
                )
            }

            # API kullanımını korumak için
            # yalnızca anlamlı adayları doğrula.
